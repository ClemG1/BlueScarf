...
public class NotAdminErrorWindow extends JFrame {
	...
	public static void start() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					NotAdminErrorWindow frame = new NotAdminErrorWindow();
	...
	public NotAdminErrorWindow() {
		...
		txtpnLoginFailedPlease.setText("You must be administrator to do that.");
