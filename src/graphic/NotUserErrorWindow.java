...
public class NotUserErrorWindow extends JFrame {
	...
	public static void start() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					NotUserErrorWindow frame = new NotUserErrorWindow();
	...
	public NotUserErrorWindow() {
		...
		txtpnLoginFailedPlease.setText("You must use the admin section.");
